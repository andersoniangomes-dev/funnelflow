    ...
    <AppLayout>
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-foreground">Eventos</h1>
            <p className="text-sm sm:text-base text-muted-foreground mt-1">Acompanhe e depure seus eventos do GA4</p>
          </div>
